...
const $$Egipcia = createComponent(($$result, $$props, $$slots) => {
  const diosesEgipcios = dioses.filter((d) => d.mitologia === "Egipcia");
  return renderTemplate`${renderComponent($$result, "Base", $$Base, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="text-center mt-10 w-full"> <div class="flex justify-center flex-col items-center"> <h1 class="text-4xl font-bold text-[#252525] mb-8">Dioses de Egipcios</h1> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:gap-2 lg:p-4 items-center"> ${diosesEgipcios.map((dios) => renderTemplate`${renderComponent($$result2, "DiosCard", $$CardDios, { "dios": dios })}`)} </div> </div> </section> ` })}`;
}, "C:/AnitaSecretCode/AnitaSecretCode/Proyectos Mapp81/Dioses/dioses/src/pages/egipcia.astro", void 0);

const $$file = "C:/AnitaSecretCode/AnitaSecretCode/Proyectos Mapp81/Dioses/dioses/src/pages/egipcia.astro";
const $$url = "/egipcia";
