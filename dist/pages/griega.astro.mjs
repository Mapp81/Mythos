...
const $$Griega = createComponent(($$result, $$props, $$slots) => {
  const diosesGriegos = dioses.filter((d) => d.mitologia === "Griega");
  return renderTemplate`${renderComponent($$result, "Base", $$Base, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="text-center mt-10 w-full"> <div class="flex justify-center flex-col items-center"> <h1 class="text-4xl font-bold text-[#252525] mb-8">Dioses de Grecia</h1> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:gap-2 lg:p-4 items-center"> ${diosesGriegos.map((dios) => renderTemplate`${renderComponent($$result2, "DiosCard", $$CardDios, { "dios": dios })}`)} </div> </div> </section> ` })}`;
}, "C:/AnitaSecretCode/AnitaSecretCode/Proyectos Mapp81/Dioses/dioses/src/pages/griega.astro", void 0);

const $$file = "C:/AnitaSecretCode/AnitaSecretCode/Proyectos Mapp81/Dioses/dioses/src/pages/griega.astro";
const $$url = "/griega";
